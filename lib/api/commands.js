...
module.exports = {
    Key: {
        ...
        Z1od34u: "AccountService.Account.UPDATE_EMAIL",
        ...
        vMevG: "AccountService.Account.REMOVE_DEVICE",
        ZqK1Gz: "AccountService.Account.DELETE",
        Z1MpJXi: "AccountService.Account.On.EMAIL_UPDATED",
        Z14wWUM: "AccountService.Account.On.PROFILE_UPDATED",
        "2ajtNs": "AccountService.Account.On.DELETED",
        iY6g5: "AccountService.Session.SIGN_IN",
        Z1MCuQg: "AccountService.Session.TOKEN_SIGN_IN",
        oaGnV: "AccountService.Session.ACTIVE_SESSIONS",
        Z2TCLI: "AccountService.Session.SET_STATE",
        ZvQ4OR: "AccountService.Session.SIGN_OUT",
        dBV4B: "AccountService.Session.TOKEN_SIGN_OUT",
        "2uEnPV": "AccountService.Session.SEND_NOTIFICATIONS",
        W0Ktc: "AccountService.Roster.ADD_PARTNER",
        Z1otpxy: "AccountService.Roster.REMOVE_PARTNER",
        "1A3szC": "AccountService.Roster.BLOCK_PARTNER",
        Z1Uo3YY: "AccountService.Roster.UNBLOCK_PARTNER",
        ...
        "1Trm8X": "AccountService.Roster.GET_BLOCKED_PARTNERS",
        ...
        Z15MQmV: "AccountService.Roster.On.PARTNER_BLOCKED",
        "1dw2Lr": "AccountService.Roster.On.PARTNER_UNBLOCKED",
        ...
        ZUXIoS: "ChatService.Message.On.MESSAGE_IMAGES",
        ...
        "1jtjB9": "ChatService.Conversation.On.UPDATED",
        ...
        "1x8Y6R": "ImageService.Chat.BULID_IMAGES",
        Z1dAytN: "HelpDeskService.HDSuperAdmin.ADD",
        Z1W6VcE: "HelpDeskService.HDSuperAdmin.DELETE",
        RQDxe: "HelpDeskService.HDAdmin.ADD",
        ZiohsU: "HelpDeskService.HDAdmin.DELETE",
        ZTNheW: "HelpDeskService.Agent.GET_ROLE",
        ZTGsG4: "HelpDeskService.Agent.ADD",
        OyEpI: "HelpDeskService.Agent.UPDATE",
        eGKpk: "HelpDeskService.Agent.DELETE",
        "2cCK2u": "HelpDeskService.Agent.LIST",
        Z1AwjPm: "HelpDeskService.Agent.LIST_QUEUES",
        Zak2m9: "HelpDeskService.Category.CREATE",
        qK2ai: "HelpDeskService.Category.UPDATE",
        Z67BTQ: "HelpDeskService.Category.LIST",
        Z1QodsW: "HelpDeskService.Queue.CREATE",
        Z1fj8Vv: "HelpDeskService.Queue.UPDATE",
        Zzzahk: "HelpDeskService.Queue.ACTIVATE",
        MD8Sl: "HelpDeskService.Queue.LIST",
        Z26SzIH: "HelpDeskService.Queue.LIST_ALL",
        "1WUtjL": "HelpDeskService.Request.SEND",
        "2bU8Cq": "HelpDeskService.Request.DELETE",
        ZfnUNI: "HelpDeskService.Request.PROCESS",
        ZHxO54: "HelpDeskService.Request.NEXT_PAGE",
        Z1qiuHw: "HelpDeskService.Request.On.REQUEST",
        Z1WgRry: "HelpDeskService.Request.On.STATE_CHANGE",
        "1rimlf": "HelpDeskService.Request.On.DELETE",
    ...
    AccountService: {
        ...
        Session: {
            ...
            ACTIVE_SESSIONS: "oaGnV",
            SET_STATE: "Z2TCLI",
            SIGN_OUT: "ZvQ4OR",
            TOKEN_SIGN_OUT: "dBV4B",
            SEND_NOTIFICATIONS: "2uEnPV"
        },
        Roster: {
            ADD_PARTNER: "W0Ktc",
            REMOVE_PARTNER: "Z1otpxy",
            BLOCK_PARTNER: "1A3szC",
            UNBLOCK_PARTNER: "Z1Uo3YY",
            GET_OFFLINE_NEXT_PAGE: "Zn81jE",
            GET_ONLINE_NEXT_PAGE: "Z14pECD",
            GET_RECENT_PARTNERS: "Z2bQOMI",
            SEARCH_PARTNERS: "Z2nHN9B",
            GET_BLOCKED_PARTNERS: "1Trm8X",
            On: {
                STATE_CHANGED: "b0RKC",
                PARTNER_ADDED: "2onRHm",
                PARTNER_REMOVED: "dAPo3",
                PARTNER_BLOCKED: "Z15MQmV",
                PARTNER_UNBLOCKED: "1dw2Lr"
            }
        }
    },
    ChatService: {
