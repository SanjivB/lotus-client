...
Blob.prototype.listBlobs = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.BlobService.Blob.LIST_BLOBS, param, null, callback);
};
...
Agent.prototype.addAdmin = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Agent.ADD_ADMIN, param, null, callback);
};

Agent.prototype.deleteAdmin = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Agent.DELETE_ADMIN, param, null, callback);
};
