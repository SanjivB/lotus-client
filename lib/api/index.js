...
function API(pipe) {
    ...
    this.HelpDeskService = new HelpDeskService(this.pipe);
    this.NotificationService = new NotificationService(this.pipe);
    this.ImageService = new ImageService(this.pipe);
};
...
function ImageService(pipe) {
    this.Chat = new Chat(pipe);
};
...
function HelpDeskService(pipe) {
    this.HDSuperAdmin = new HDSuperAdmin(pipe);
    this.HDAdmin = new HDAdmin(pipe);
    this.Agent = new Agent(pipe);
    this.Category = new Category(pipe);
    this.Queue = new Queue(pipe);
    this.Request = new Request(pipe);
};

function HDSuperAdmin(pipe) {
    this.pipe = pipe;
    this.Enum = this.pipe.Enum;
};

function HDAdmin(pipe) {
    this.pipe = pipe;
    this.Enum = this.pipe.Enum;
};
...
Account.prototype.updateEmail = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.AccountService.Account.UPDATE_EMAIL, param, null, callback);
};
...
Account.prototype.removeDevice = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.AccountService.Account.REMOVE_DEVICE, param, null, callback);
};

Account.prototype.delete = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.AccountService.Account.DELETE, param, null, callback);
};

Account.prototype.onEmailUpdated = function(callback) {
    this.pipe.on(this.Enum.Command.AccountService.Account.On.EMAIL_UPDATED, callback);
};
...
Account.prototype.onDeleted = function(callback) {
    this.pipe.on(this.Enum.Command.AccountService.Account.On.DELETED, callback);
};

Session.prototype.signIn = function(param, callback) {
    param.sessionId = this.pipe.sessionId;
...
Session.prototype.activeSessions = function(callback) {
    this.pipe.sendRequest(this.Enum.Command.AccountService.Session.ACTIVE_SESSIONS, null, null, callback);
};
...
Session.prototype.tokenSignOut = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.AccountService.Session.TOKEN_SIGN_OUT, param, null, callback);
};

Session.prototype.sendNotifications = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.AccountService.Session.SEND_NOTIFICATIONS, param, null, callback);
};
...
Roster.prototype.blockPartner = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.AccountService.Roster.BLOCK_PARTNER, param, null, callback);
};

Roster.prototype.unblockPartner = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.AccountService.Roster.UNBLOCK_PARTNER, param, null, callback);
};
...
Roster.prototype.getBlockedPartners = function(callback) {
    this.pipe.sendRequest(this.Enum.Command.AccountService.Roster.GET_BLOCKED_PARTNERS, null, null, callback);
};
...
Roster.prototype.onPartnerBlocked = function(callback) {
    this.pipe.on(this.Enum.Command.AccountService.Roster.On.PARTNER_BLOCKED, callback);
};

Roster.prototype.onPartnerUnblocked = function(callback) {
    this.pipe.on(this.Enum.Command.AccountService.Roster.On.PARTNER_UNBLOCKED, callback);
};
...
Message.prototype.onMessageImages = function(callback) {
    this.pipe.on(this.Enum.Command.ChatService.Message.On.MESSAGE_IMAGES, callback);
};
...
Chat.prototype.bulidImages = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.ImageService.Chat.BULID_IMAGES, param, null, callback);
};

HDSuperAdmin.prototype.add = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.HDSuperAdmin.ADD, param, null, callback);
};

HDSuperAdmin.prototype.delete = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.HDSuperAdmin.DELETE, param, null, callback);
};

HDAdmin.prototype.add = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.HDAdmin.ADD, param, null, callback);
};

HDAdmin.prototype.delete = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.HDAdmin.DELETE, param, null, callback);
};

Agent.prototype.getRole = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Agent.GET_ROLE, param, null, callback);
};

Agent.prototype.add = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Agent.ADD, param, null, callback);
};

Agent.prototype.update = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Agent.UPDATE, param, null, callback);
};

Agent.prototype.delete = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Agent.DELETE, param, null, callback);
};

Agent.prototype.list = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Agent.LIST, param, null, callback);
};

Agent.prototype.listQueues = function(callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Agent.LIST_QUEUES, null, null, callback);
};

Category.prototype.create = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Category.CREATE, param, null, callback);
};

Category.prototype.update = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Category.UPDATE, param, null, callback);
};

Category.prototype.list = function(callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Category.LIST, null, null, callback);
};

Queue.prototype.create = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Queue.CREATE, param, null, callback);
};

Queue.prototype.update = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Queue.UPDATE, param, null, callback);
};

Queue.prototype.activate = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Queue.ACTIVATE, param, null, callback);
};

Queue.prototype.list = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Queue.LIST, param, null, callback);
};

Queue.prototype.listAll = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Queue.LIST_ALL, param, null, callback);
};

Request.prototype.send = function(param, callback) {
    param.body = this.messageHelper.toJson(param.body);

    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Request.SEND, param, null, callback);
};

Request.prototype.delete = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Request.DELETE, param, null, callback);
};

Request.prototype.process = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Request.PROCESS, param, null, callback);
};

Request.prototype.nextPage = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Request.NEXT_PAGE, param, null, callback);
};

Request.prototype.onRequest = function(callback) {
    var self = this;
    this.pipe.on(this.Enum.Command.HelpDeskService.Request.On.REQUEST, function(error, result, payload, roundTripTime, serverLatency) {
        if (!error) {
            result.request.body = self.messageHelper.fromJson(result.request.body);
        }
        callback(error, result, payload, roundTripTime, serverLatency);
    });
};

Request.prototype.onStateChange = function(callback) {
    this.pipe.on(this.Enum.Command.HelpDeskService.Request.On.STATE_CHANGE, callback);
};

Request.prototype.onDelete = function(callback) {
    this.pipe.on(this.Enum.Command.HelpDeskService.Request.On.DELETE, callback);
};
