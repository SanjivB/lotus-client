...
Request.prototype.previousPage = function(param, callback) {
    this.pipe.sendRequest(this.Enum.Command.HelpDeskService.Request.PREVIOUS_PAGE, param, null, callback);
};
